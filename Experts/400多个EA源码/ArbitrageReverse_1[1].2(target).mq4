...
//+------------------------------------------------------------------+
//Added target balance and target loss balance-Yast77
...
extern double TargetBalance=100000000.00;
extern double TargetLoss=0.00;
//+------------------------------------------------------------------+
...
int start()
  ...
  if((AccountEquity()>=TargetBalance) || (AccountEquity()<=TargetLoss) )
  {
  Comment(
              "\nSTOP TRADING....",
              "\nAccountEquity = ", AccountEquity(),
              "\nTarget Balance or Target Loss hit !!");	
  closeall();
   return(0);
  }
